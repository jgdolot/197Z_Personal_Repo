...
def get_args():
    ...
    parser.add_argument('--max-epochs', type=int, default=30, metavar='N',
                        help='number of epochs to train (default: 30)')  ### <========== EPOCH!!!! =======================================================================
    ...
    parser.add_argument("--num-classes", type=int, default=37)  ### <========== NUM_CLASSES!!!! =======================================================================
    ...
    parser.add_argument("--accelerator", default='gpu') ### <========== GPU/CPU =======================================================================
    ...
    parser.add_argument('--patch_num', type=int, default=8, help='patch_num')  ### <========== PATCH_NUM! =======================================================================
...
if __name__ == "__main__":
    ...
    trainer.save_checkpoint(os.path.join(args.path, "checkpoints", "trans-kws-best-acc.ckpt"))
